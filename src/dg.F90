   ...
   SUBROUTINE QUADRATURE(D, REGION, PTS, WTS, N, SZ2, SZ3)
      ...
      ELSEIF (REGION == 'SQUARE  ') THEN
         ...
         ELSEIF (D <= 10) THEN ! Ref []
            ...
            ALLOCATE (A(L), B(L), M(L), W(L))
            M(1:L) = 1
            A(1:L) = [4.732489884927659D-01, &
                      -3.507267260891898D-01, &
                      -4.711392149070168D-01, &
                      3.211002312038651D-02, &
                      1.0733227865108741d-01, &
                      8.103749226019181D-01, &
                      -7.788254159831851D-01, &
                      -6.476354842626753D-01, &
                      3.924748753960961D-01, &
                      7.605065507139738D-01, &
                      -8.117151060164873D-01, &
                      -1.142951736422379D-01, &
                      7.529656324799600D-01, &
                      -6.240243795898470D-01, &
                      -2.0650134619887220d-01, &
                      5.0891319042960681d-01, &
                      -9.817119264047968D-01, &
                      -9.406185571992117D-01, &
                      -9.225481682574119D-01, &
                      9.538019223425511D-01, &
                      9.663420836873585D-01, &
                      9.577495916000752D-01]
            B(1:L) = [1.655785251003831D-01, &
                      1.844717206212198D-01, &
                      -6.666473305982112D-01, &
                      -3.187935759364070D-01, &
                      6.188661913929924D-01, &
                      6.115967830349250D-01, &
                      -2.105273891482155D-01, &
                      6.474946981752544D-01, &
                      -7.631114939243834D-01, &
                      -3.663139167806793D-01, &
                      -9.246684242905354D-01, &
                      -9.492191314088701D-01, &
                      -9.707183739677747D-01, &
                      9.853833119314601D-01, &
                      9.119588710357342D-01, &
                      9.215290755789826D-01, &
                      -6.258661935323967D-01, &
                      3.188453596839291D-01, &
                      8.792348043990322D-01, &
                      -7.551269206143554D-01, &
                      1.0431232556636386d-01, &
                      9.262105001258389D-01]
            W(1:L) = [3.717176493089617D-01, &
                      3.881144740244087D-01, &
                      2.839584221827893D-01, &
                      4.0824197726154576d-01, &
                      3.149887822123113D-01, &
                      2.0018320620277513d-01, &
                      2.658711347712602D-01, &
                      2.305700455337008D-01, &
                      2.582793941034280D-01, &
                      2.604239768191685D-01, &
                      8.868620221697549D-02, &
                      1.186176720746597D-01, &
                      5.911019515035114D-02, &
                      3.338712924707303D-02, &
                      1.346097738619807D-01, &
                      1.333773119224011D-01, &
                      6.326927276111099D-02, &
                      1.198415853239126D-01, &
                      6.253794118755214D-02, &
                      7.180589876051665D-02, &
                      9.794042948413193D-02, &
                      3.446752558898381D-02]
            !-----------------------------------------------------------------------
         ...
         ELSEIF (D <= 12) THEN ! Ref [ ]
            ...
            ALLOCATE (A(L), B(L), M(L), W(L))
            M(1:L) = 1
            A(1:L) = [-3.813111945914878D-01, &
                      6.457319110945394D-02, &
                      -1.0834321329194775d-02, &
                      -3.188270302085193D-01, &
                      4.912405144009280D-01, &
                      -2.0906799447670715d-01, &
                      1.894833718927212D-01, &
                      -6.974009411456882D-01, &
                      -5.840251358955364D-01, &
                      4.470137723797731D-01, &
                      3.486791220837801D-01, &
                      -8.256269791464084D-01, &
                      8.283979466924894D-02, &
                      -4.0351974647584699d-01, &
                      6.540104205640623D-01, &
                      -9.0264377285460362d-01, &
                      -8.529539755192707D-01, &
                      8.221678629590165D-01, &
                      7.451055577049701D-01, &
                      -9.413398636231517D-01, &
                      -5.446118738761217D-01, &
                      7.440732296690898D-01, &
                      -7.225488548149260D-01, &
                      6.752440656935273D-01, &
                      9.380767697519552D-01, &
                      -9.917140876471077D-01, &
                      -9.739114935874884D-01, &
                      -9.223129523711365D-01, &
                      9.555770801958396D-01, &
                      9.821659129504342D-01, &
                      9.255721233512985D-01]
            B(1:L) = [-1.539800078419991D-01, &
                      -4.979487156865724D-01, &
                      1.222447897165770D-01, &
                      -7.329489889386574D-01, &
                      -7.840925768872724D-01, &
                      6.561105149729853D-01, &
                      8.991180553673828D-01, &
                      -4.224812703380752D-01, &
                      3.310064537871630D-01, &
                      -2.265966497367784D-01, &
                      4.386040495516379D-01, &
                      -7.833922327558099D-01, &
                      -9.423079869508574D-01, &
                      9.648288109634318D-01, &
                      7.385709802867503D-01, &
                      -1.588185221137936D-02, &
                      4.0163251602231481d-01, &
                      -5.266074869225626D-01, &
                      1.0988549815212308d-01, &
                      -9.541414814296441D-01, &
                      -9.553003637912244D-01, &
                      -9.774483546067361D-01, &
                      7.966223064963052D-01, &
                      9.962611048590968D-01, &
                      8.872924402665820D-01, &
                      -5.285394547745432D-01, &
                      5.995534054823865D-01, &
                      9.508259234372828D-01, &
                      -8.490335341854722D-01, &
                      -1.636971136377447D-01, &
                      4.742588043433085D-01]
            W(1:L) = [2.359870129293369D-01, &
                      2.411081360084784D-01, &
                      2.704822422763959D-01, &
                      1.864816688088414D-01, &
                      1.724195839388987D-01, &
                      2.410944209282151D-01, &
                      1.412539145324721D-01, &
                      1.829202545497374D-01, &
                      2.222299758186435D-01, &
                      2.490453778577003D-01, &
                      2.511236222946249D-01, &
                      9.281135999880296D-02, &
                      9.823833717308723D-02, &
                      6.858381774388923D-02, &
                      1.550693844444964D-01, &
                      1.318232088136606D-01, &
                      6.0068518355283269d-02, &
                      1.576601851977328D-01, &
                      1.993086060264342D-01, &
                      2.171910937909232D-02, &
                      6.459609875882421D-02, &
                      4.0584519909105145d-02, &
                      1.260334100793908D-01, &
                      3.0006912476756006d-02, &
                      4.497475332926139D-02, &
                      3.872124457728826D-02, &
                      4.771805692237907D-02, &
                      3.0056189691189335d-02, &
                      4.449928284652882D-02, &
                      5.656609322389026D-02, &
                      9.681470110956133D-02]
            !-----------------------------------------------------------------------
